          ...
          <span>
            ...
            <v-row>
              <v-col cols="12" lg="7" md="7">
                <v-form ref="form" lazy-validation class="pa-4" transition="slide-x-transition">
                  <v-row>
                  ...
                  <v-row>
                    ...
                    <v-col class="pb-0 pt-0" cols="12" sm="6">
                      ...
                      >
                        ...
                        <v-date-picker v-model="formData.dob" no-title scrollable>
                          <v-spacer></v-spacer>

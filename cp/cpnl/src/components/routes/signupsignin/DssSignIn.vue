<template>
  <v-container class="full-height" fluid>
    ...
    <v-row
      style="margin-top:3%; vertical-align: middle; !important"
      align="center"
      justify="center"
    >
      <v-col cols="12" sm="8" md="8">
        ...
        <v-card
          ...
          v-show="compLoaded"
        >
          <v-progress-linear :active="dialog" :indeterminate="dialog" absolute top color="matgreen"></v-progress-linear>
          <div align="center">
            <v-img
              max-width="200"
              min-width="170"
          ...
          <v-form ref="form" lazy-validation class="pa-4" >
            ...
            <br />
            <v-row>
              <v-btn class="elevation-0" style="margin-left:2.5%" to="signup">Create An Account</v-btn>

      ...
      <template>
        ...
        >
              ...
              <v-dialog scrollable v-model="dialog" max-width="500px">
                ...
                <v-card>
                  ...
                  <v-card-text  style="height: 400px;">
                    <!-- <div class="vc-ov"> -->
                      <v-form ref="form" v-model="productsForm"  style="height: 400px;" lazy-validation class="pa-4">
                        <v-row>
                  ...
                  <v-card-actions>
                    ...
                    <v-btn style="margin:10px" color="teal" dark class="mb-2" @click="close">Cancel</v-btn>
          ...
          <template v-slot:item.imageLink="{ item }">
            <v-img
              style="margin=4px;border-radius: .5em;"
              :src="item.images[0]"
          ...
          <template v-slot:item.inStock="{ item }">
            <v-chip :color="getColor(item.inStock)" dark>{{getStockAns( item.inStock) }}</v-chip>
          </template>

          <template v-slot:item.actions="{ item }">
            <v-icon color="feay" small class="mr-2" @click="editItem(item)">mdi-pencil</v-icon>
...
export default {
  ...
  methods: {
    initialize() {
      this.prdcts = this.productsData.products.products;
    },
    ...
    uploadPic() {
      ...
      axios({
        method: "post",
        url:
          "https://dokanee-backend-monolithic.herokuapp.com/dashboard/store/b56ee0be-d72b-4255-bdb1-56994edbc4be/product/image/e0fbea0d-6389-4775-931d-5a41e07631dd",
        data: form,
        headers: {

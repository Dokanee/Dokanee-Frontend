...
export default {
    data() {
        ...
        // userinfo:  {
        //     "role": "Store Owner",
        //     "about": "This is about an user info. this is very importent. but here it a dummy text. we are working on it.",
        //     "phone": "01734543027",
        //     "address": "23/A Velanagar, Narsingdi, Dhaka, Bangladesh",
        //     "dob": "31 May 1999",
        //     "firstName": "Abdullah Al",
        //     "lastName": "Habib",
        //     "email": "aalhabib001@gmail.com"
        // },
        socials: [
        {
          icon: 'mdi-facebook',
    ...
    methods: {
      ...
      userinfoAPI () {
          var self = this
          axios.get('https://dokanee-backend-monolithic.herokuapp.com/profile/getUserInfo', { 'headers': { 'Authorization': data().Auth }})
          .then( response => {

...
<!-- hello -->
        ...
        >
          ...
          <template v-slot:item.fullname="{ item }">
            <span><v-avatar size="35" style="margin: 8px 8px 8px 0px;border:1px solid #ECEFF1">
                <img
                  :src="item.avater"
                >
              </v-avatar>   {{item.first_name}} {{item.last_name}}</span>
          </template>
    ...
    methods: {
      initialize () {
        this.person = [{
                  ...
                  "avater": "data:image/png;base64,"
                }, {
                  "id": 2,
                  "first_name": "Tore",
                  "last_name": "Dulake",
                  ...
                  "avater": "data:image/png;base64,"
                }, {
                  "id": 20,
                  "first_name": "Geneva",
                  "last_name": "Cadwell",
